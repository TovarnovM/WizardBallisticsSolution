...
namespace RL_ipv4
{
    ...
    public class ServiceHost : IDisposable
    {
        ...
        public ServiceHost(object singletonInstance, int port)
        {
            ...
            _endPoint = new IPEndPoint(Ipv4(hostEntry.AddressList), port);
        ...
        public static IPAddress Ipv4(IPAddress[] HostAddresses) {
            foreach (IPAddress currentIPAddress in HostAddresses) {
