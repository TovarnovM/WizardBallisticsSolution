...
namespace Sharp3D.Math.Core
{
    ...
    public struct QuaternionD : ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// Единичный вектор по оси вращения
        /// </summary>
        public Vector3D Axis_norm {
            get {
                Vector3D vec = new Vector3D(_x, _y, _z);
                vec.Normalize();
                return vec;
            }
        }
        ...
        public static Matrix4D QuaternionToMatrix(QuaternionD q) 
        {
            ...
            double wz = w * z;
            return new Matrix4D(
                1d - 2d * yy - 2d * zz,  2d * xy - 2d * wz, 	   2d * xz + 2d * wy,       0d,
                2d * xy + 2d * wz,       1d - 2d * xx - 2d * zz,   2d * yz - 2d * wx,       0d,
                2d * xz - 2d * wy,       2d * yz + 2d * wx,        1d - 2d * xx - 2d * yy,  0d,
                0d,                      0d,                       0d,                      1d);
        }
        ...
        /// </summary>
        /// <param name="q">A <see cref="QuaternionD"/> instance.</param>
        /// <returns>A new <see cref="Matrix3D"/> instance.</returns>
        public static Matrix3D QuaternionToMatrix3D(QuaternionD q) {
            ...
            double wz = w * z;
            return new Matrix3D(
                1d - 2d * yy - 2d * zz,2d * xy - 2d * wz,2d * xz + 2d * wy,
                2d * xy + 2d * wz,1d - 2d * xx - 2d * zz,2d * yz - 2d * wx,
                2d * xz - 2d * wy,2d * yz + 2d * wx,1d - 2d * xx - 2d * yy);
        }
